...
{{--                <img src="/images/heidi-banner.png" alt="heidi banner" class="img-fluid rounded">--}}
            </div>
            <div class="mx-5 mt-3">
                <h1 class="text-uppercase text-black text-center">Check Back Soon For Our Next Production.</h1>

                <div class="row">
                    <div class="col-sm col-md-4">
{{--                        <h1 class="text-uppercase text-black text-center">Marushka</h1>--}}
                        <p class="text-black text-center lead">
{{--                            <span class="fw-bold" style="text-decoration: underline;">Date</span>--}}
{{--                            <br>Saturday, October 29th--}}
{{--                            at 1:00 p.m. & 7:00 p.m.--}}
{{--                            <br>Sunday, October 30th--}}
{{--                            at 2:00 p.m.--}}
{{--                            <br><br>--}}
{{--                            <span class="fw-bold" style="text-decoration: underline;">Pricing</span>--}}
{{--                            <br>Orchestra: $24--}}
{{--                            <br>Balcony: $20--}}
{{--                            <br>Youth (18 and under): $10 all locations--}}
                        </p>
                        <div class="d-flex justify-content-center my-3 text-black text-center">
{{--                            Tickets will be on sale shortly. Please check back soon.--}}
{{--                            <a href="https://www.webercenterarts.org/event/heidi-2021/2021-11-13/" target="_blank"><div class="btn btn-lg btn-info text-uppercase shadow" style="font-family: 'Oswald', sans-serif;">Buy Tickets Now</div></a>--}}
                        </div>
                    </div>
{{--                    <div class="col-sm col-md-8" style="border-left: 1px solid lightslategrey;">--}}
                        <h3 class="text-black">
{{--                            Welcome to Ballet La Crosse’s timeless story of Heidi,  the adventure-filled story of a young orphan sent to live with her grandfather in the mountains of Switzerland.--}}
                        ...
                        <p class="text-black">
{{--                            Based on a Russian fairytale, “Marushka” is essentially a Slavic Cinderella — mistreated by her stepmother and burdened with the impossible task of delivering a special flower to the kingdom's spoiled princess in the dead of winter. It's a story about the power of nature.--}}
                            <br>
                            <br>
{{--                            More about Marushka coming soon.--}}
